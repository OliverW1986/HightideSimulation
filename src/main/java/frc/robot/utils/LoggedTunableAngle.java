...
// public class LoggedTunableAngle implements Supplier<Measure> {
...
//    */
//   public LoggedTunableAngle(String dashboardKey) {
...
//    */
//   public LoggedTunableAngle(String dashboardKey, double defaultValue) {
//     this(dashboardKey);
